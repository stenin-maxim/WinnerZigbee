            ...
            `
                ...
                <div style="font-size: 15px">
                    ...
                    <div style="margin: 0 0 5px 10px;">
                        ...
                        <p style="margin: 10px 0px">При нажатии на датчик появатся настройки, можно удалить, заменить, переименовать имя данного датчика.</p>
                        ...
                        <p style="margin: 10px 0px">Приложение переведено на английский и русский язык. Язык устанавливается в зависимотси от настроек телефона.</p>
                    </div>
                </div>
            `,
    };
